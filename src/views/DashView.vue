  ...
  <div class="min-h-screen flex bg-gray-100 width=device-width, initial-scale=1.0">
    ...
    <div
      ...
      <div class="flex flex-col items-center space-y-8">
        ...
        <!-- Komunitas Button -->
        <button class="flex flex-col items-center justify-center p-4 rounded-lg transition-all duration-300"
          @click="setActivePage('community')" :class="activePage === 'community'
            ? 'bg-gradient-to-r from-blue-500 to-indigo-600 text-white shadow-lg'
            : 'text-gray-500 hover:bg-gray-300 hover:shadow-lg'">
          <i :class="activePage === 'community'
    ...
    <!-- ASIDE CONTACT-->
    <AsideChat :isVisible="isSidebarVisible" />
    <AsideSetting v-if="activePage === 'settings'" />
    <AsideCommunity v-if="activePage === 'community'" />
    ...
    <div class="flex-grow bg-black ">
      ...
      <!-- Komunitas -->
      <section v-if="activePage === 'community'">
        <h1 class="text-3xl font-bold mb-4 text-blue-600">Komunitas</h1>
        <p class="text-gray-700">Ini adalah halaman community.</p>
      </section>
...
import AsideChat from "./aside/AsideChat.vue";
import AsideSetting from "./aside/AsideSetting.vue";
import AsideCommunity from "./aside/AsideCommunity.vue";
